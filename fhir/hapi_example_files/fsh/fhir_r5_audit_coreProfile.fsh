...
# About:      Example for the HL7 AT PICA AuditEvent Core Profile
# Created by: AISt
##############################################################################*/

Instance:    AISTPICAAuditEventCoreExample01
InstanceOf:  AuditEvent
Description: "Example AuditEvent for AIST PICA Core Profile"
Usage:       #example

* id = "2"
* meta.versionId = "1"
* meta.lastUpdated = "2025-10-17T11:52:42.176+02:00"
* meta.source = "AISTPICAAuditEventCore"
* meta.profile[0] = "http://hl7.at/fhir/AISTPICA/R5/StructureDefinition/aist-pica-auditevent-core"
