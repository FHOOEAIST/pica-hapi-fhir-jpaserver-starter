...
# About:      Example for the HL7 AT PICA AuditEvent Actor Profile
# Created by: AISt
##############################################################################*/

Instance:    AISTPICAAuditEventActorExample01
InstanceOf:  AuditEvent
Description: "Example AuditEvent for AIST PICA Actor Profile"
Usage:       #example

* id = "2"
* meta.versionId = "1"
* meta.lastUpdated = "2025-10-17T11:52:42.176+02:00"
* meta.source = "AISTPICAAuditEventActor"
* meta.profile[0] = "http://hl7.at/fhir/AISTPICA/R5/StructureDefinition/aist-pica-auditevent-actor"
